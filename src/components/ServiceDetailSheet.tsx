...
export const ServiceDetailSheet: React.FC<ServiceDetailSheetProps> = ({ serviceId, onClose, onBook }) => {
  ...
  const detailsMap: Record<string, {
    ...
    'maintenance': {
      ...
      seoContent: 'Routine maintenance is the key to extending the life of your vehicle and maximizing fuel economy. Peninsula Mobile Mechanic offers comprehensive mobile preventative maintenance, bringing essential services like full synthetic oil changes, spark plug replacements, and fluid top-offs directly to you in Hampton or Newport News. Instead of wasting your Saturday in a dealership waiting room, let our expert mechanics perform your scheduled service while you relax at home or work. We use premium filters, high-grade fluids, and OEM-quality parts to keep your car running like new.',
      servicesIncluded: [
